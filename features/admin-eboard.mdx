...
sidebarTitle: "Eboard"
description: "Developer reference for creating, editing, and deleting eboard role entries: rank ordering, role_email vs member email, the EboardModal form, and the /eboard API endpoints."
---
