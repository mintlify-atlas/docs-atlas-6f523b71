...
The entire right-side button group (bell + Slack) is conditionally excluded. No fetch is prevented — the announcement fetch still runs — but the UI is invisible to alumni.
