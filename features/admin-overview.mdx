...
description: "Developer map of the Admin Dashboard at /admin: eight sections, access control, data-fetch order, layout, and the global confirm dialog pattern."
---
...
<CardGroup cols={2}>
  ...
  <Card title="Archived Members" icon="archive" href="/features/admin-members#archived-members-panel">
    Soft-deleted members. Restore with a single click; they re-appear in the active list immediately.
  </Card>
  <Card title="Alumni Members" icon="graduation-cap" href="/features/admin-members#alumni-members-panel">
